...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        BlurbAdapter blurbAdapter = new BlurbAdapter(cursor);
        blurbAdapter.setHasStableIds(true);
        mRecyclerView.setAdapter(blurbAdapter);
    ...
    private class BlurbAdapter extends RecyclerView.Adapter<ViewHolder> {
        private Cursor mCursor;

        public BlurbAdapter(Cursor cursor) {
            mCursor = cursor;
        }
